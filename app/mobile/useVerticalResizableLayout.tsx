...
export function useVerticalResizableLayout({
    ...
    const [startY, setStartY] = useState(0); // добавить
    ...
    useEffect(() => {
        if (isResizing) {
            ...
            document.addEventListener('touchmove', handleTouchMove); // добавить
            document.addEventListener('touchend', handleTouchEnd);
        }
        return () => {
            document.removeEventListener('mousemove', handleMouseMove);
            document.removeEventListener('mouseup', handleMouseUp);
            document.removeEventListener('touchmove', handleTouchMove); // добавить
